...
(function ($) {
  ...
  var envisionBlocksParallax = function envisionBlocksParallax($scope, $) {
    ...
    var envisionBlocksParallaxImages = {
      ...
      parallaxElements: function parallaxElements($image) {
        var itemImage = $image,
          ...
          imgZoomCustomParallaxLevel = itemImage.find(".envision-blocks-parallax__main-image").attr("data-parallax-main"),
        ...
        if (envisionBlocks.windowWidth > 1024) {
          if (typeof imgZoomCustomParallaxLevel !== "undefined" && imgZoomCustomParallaxLevel !== false) {
            ...
            imgZoomSmoothness = Math.abs(parseInt(imgZoomParallaxLevel / 0.9, 10));
          }
          imgZoom.attr("data-parallax", '{"y" : ' + imgZoomParallaxLevel + ' , "smoothness": ' + imgZoomSmoothness + "}");
          imagesParallax.each(function () {
            ...
            imgParallax.attr("data-parallax", '{"y" : ' + imgParallaxLevel + ' , "smoothness": ' + imgParallaxSmoothness + "}");
          });
        }
      },
      initParallaxElements: function initParallaxElements() {
  ...
  jQuery(window).on("elementor/frontend/init", function () {
    elementorFrontend.hooks.addAction("frontend/element_ready/envision-blocks-parallax.default", envisionBlocksParallax);
  });
})(jQuery);
/******/ })()
;